...
class FetchUserBaseModel : NSObject, NSCoding, Mappable{

	var responseCode : Int?
	var responseData : FetchUserResponseData?
	var responseText : String?


	class func newInstance(map: Map) -> Mappable?{
		return FetchUserBaseModel()
	}
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         responseData = aDecoder.decodeObject(forKey: "responseData") as? FetchUserResponseData
