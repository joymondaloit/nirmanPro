//
//	ProductDetailsBaseResponse.swift
...
class ProductDetailsBaseResponse : NSObject, NSCoding, Mappable{

	var responseCode : Int?
	var responseData : [ProductDetailsResponseData]?
	var responseText : String?


	class func newInstance(map: Map) -> Mappable?{
		return ProductDetailsBaseResponse()
	}
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         responseData = aDecoder.decodeObject(forKey: "responseData") as? [ProductDetailsResponseData]
