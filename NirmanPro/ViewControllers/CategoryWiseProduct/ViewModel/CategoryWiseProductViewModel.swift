...
import UIKit
import ObjectMapper
class CategoryWiseProductViewModel: NSObject {
static let shared = CategoryWiseProductViewModel()
   func getCategoryList(apiName: String,param : [String:Any],vc : UIViewController, completion : @escaping (CategoryResponseModel?,Error?)->Void){
