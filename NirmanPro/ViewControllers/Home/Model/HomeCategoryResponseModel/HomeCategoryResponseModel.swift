//
//	HomeCategoryResponseModel.swift
...
class HomeCategoryResponseModel : NSObject, NSCoding, Mappable{

	var responseCode : Int?
	var responseData : [HomeCategoryResponseData]?
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         responseData = aDecoder.decodeObject(forKey: "responseData") as? [HomeCategoryResponseData]
