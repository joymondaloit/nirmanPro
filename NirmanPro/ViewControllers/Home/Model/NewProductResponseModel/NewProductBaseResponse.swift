...
class NewProductBaseResponse : NSObject, NSCoding, Mappable{

	var responseCode : Int?
	var responseData : [NewProductResponseData]?
	var responseText : String?


	class func newInstance(map: Map) -> Mappable?{
		return NewProductBaseResponse()
	}
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         responseData = aDecoder.decodeObject(forKey: "responseData") as? [NewProductResponseData]
