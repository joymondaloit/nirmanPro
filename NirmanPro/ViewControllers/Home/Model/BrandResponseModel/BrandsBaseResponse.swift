...
class BrandsBaseResponse : NSObject, NSCoding, Mappable{
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         responseData = aDecoder.decodeObject(forKey: "responseData") as? [BrandsResponseData]
